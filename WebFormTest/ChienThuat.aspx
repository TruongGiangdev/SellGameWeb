<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ChienThuat.aspx.cs" Inherits="WebFormTest.ChienThuat" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        ...
        <section class="row" aria-labelledby="aspnetTitle">
            <h1 id="aspnetTitle">Game chiến thuật</h1>
