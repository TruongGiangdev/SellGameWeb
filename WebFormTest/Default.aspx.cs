...
namespace WebFormTest
{
    public partial class _Default : Page
    {
        ...
        {
            // Chuỗi kết nối tới cơ sở dữ liệu (nên đặt trong Web.config)
            ...
            string query = "SELECT MaGame, TenGame, MoTa, DonGia, Anh FROM Game";
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(query, conn))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        // xóa col-lg-3 col-xl-3 để hiển thị 3 cột
                        productList.InnerHtml += $@"
                            <div class='col-6 col-sm-6 col-md-4 product-item'>
                                <div class='card'>
                                    <a href='ChiTietSP.aspx?name={tenGame}&price={donGia}&image={anh}&description={moTa}&id={maGame}' style='text-decoration: none; color: inherit;'>
