<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="TheThao.aspx.cs" Inherits="WebFormTest.TheThao" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        ...
        <section class="row" aria-labelledby="aspnetTitle">
            <h1 id="aspnetTitle">Game thể thao</h1>
